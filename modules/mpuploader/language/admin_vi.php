...
$lang_module['album_num_photo'] = 'Số File';
$lang_module['album_status'] = 'Trạng thái';
$lang_module['album_date_added'] = 'Ngày thêm';
$lang_module['album_folder'] = 'Thư mục chứa File';
...
$lang_module['album_image'] = 'Upload File';
$lang_module['album_info_image'] = 'Thông tin File';
$lang_module['album_next_step'] = 'Bước kế tiếp';
$lang_module['album_step_1'] = 'Bước 1: Tạo Album';
$lang_module['album_step_2'] = 'Bước 2: Chọn và tải File';
$lang_module['album_step_3'] = 'Bước 3: Cập nhật thông tin File';
...
$lang_module['album_error_folder'] = 'Lỗi: Tên thư mục lưu File không được để trống';
...
$lang_module['album_error_create_folder'] = 'Lỗi: không tạo được thư mục lưu File. Hãy kiểm tra lại việc Chmod hệ thống';
$lang_module['album_error_defaults'] = 'Lỗi: Bạn phải chọn một File đại diện cho album';
$lang_module['album_error_copy_photo'] = 'Lỗi di chuyển File';
$lang_module['album_error_mime'] = 'Định dạng File không xác định';
$lang_module['album_success_delete'] = 'Album đã được xoá thành công';
$lang_module['album_error_delete'] = 'Không có album nào được xoá';
/*function album*/

/*photo*/
$lang_module['photo_defaults'] = 'Chọn làm File đại diện album';
$lang_module['photo_name'] = 'Tên File';
$lang_module['photo_description'] = 'Mô tả File';
$lang_module['photo_success_delete'] = 'Xoá File thành công';
$lang_module['photo_error_delete'] = 'Lỗi bảo mật File này không thể xoá';
$lang_module['photo_error_delete'] = 'Lỗi bảo mật File này không thể xoá';
...
$lang_module['setting_origin_size'] = 'Kích thước File gốc (WidthxHeight)';
$lang_module['setting_cr_thumb_size'] = 'Kích thước tự tạo File Thumbs (WidthxHeight)';
$lang_module['setting_cr_thumb_quality'] = 'Chất lượng File';
...
$lang_module['setting_album_view'] = 'Phương án hiển thị File thuộc album';
$lang_module['setting_per_line'] = 'Hiển thị trên một dòng';
$lang_module['setting_per_page_album'] = 'Số album trên một trang';
$lang_module['setting_per_page_photo'] = 'Số File trên một trang';
...
$lang_module['setting_active_logo'] = 'Kích hoạt đóng dấu File';
$lang_module['setting_logo'] = 'Logo đóng dấu File';
$lang_module['setting_autologosize1'] = 'Nếu chiều rộng File &lt; = 150px';
$lang_module['setting_autologosize2'] = 'Nếu chiều rộng File &gt; 150px, &lt; 350px';
$lang_module['setting_autologosize3'] = 'Nếu chiều rộng File &gt; = 350px';
...
$lang_module['setting_structure_upload'] = 'Thư mục lưu album File';
...
$lang_module['logoposcentercenter'] = 'Chính giữa File';
