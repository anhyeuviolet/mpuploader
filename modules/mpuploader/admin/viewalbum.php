...
$album_id = $nv_Request->get_int( 'album_id', 'get', 1 );
...
if( !empty( $array ) )
{
	foreach( $array as $item )
	{
		...
		$item['edit'] = NV_BASE_ADMINURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=main&action=edit&token=" . $item['token'] . "&row_id=" . $item['row_id'];
